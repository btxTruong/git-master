...
## Description
Test complete staging workflow including staging files, unstaging files, stage all, and diff preview functionality.
...
## Technical Details
- **File to create**: `frontend/src/components/workflow`
